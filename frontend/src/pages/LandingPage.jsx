      ...
      <div className={landingPageStyles.container}>
            ...
            <div className={landingPageStyles.mobileMenu}>
              <div className={landingPageStyles.mobileMenuContainer}>
                {user ? (
                  ...
                  <button
                    className={landingPageStyles.mobileAuthBuutton}
                    onClick={() => {
                      setOpenAuthModal(true);
                      setMobileMenuOpen(false);
                    }}
            ...
            <div className={landingPageStyles.heroGrid}>
              ...
              <div className={landingPageStyles.heroLeft}>
                ...
                <p className={landingPageStyles.description}>
                  Create job-winning resumes with expertly designed templetes.
                </p>
              ...
              <div className={landingPageStyles.ctaCard}>
                ...
                <div className={landingPageStyles.ctaCardContent}>
                  ...
                  <p className={landingPageStyles.ctaDescription}>
                    Join thousands of professional who landed their dream job
                    with our platform
                  </p>
                  <button
                  ...
                  >
                    ...
                    <div className={landingPageStyles.ctaButtonText}>
                      Start Building Now
                    </div>
                  </button>
                </div>
        ...
        <footer className={landingPageStyles.footer}>
          <div className={landingPageStyles.footerContainer}>
            <p className={landingPageStyles.footerText}>Crafted by Sourik</p>
          </div>
        </footer>
