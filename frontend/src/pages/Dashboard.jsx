...
export const Dashboard = () => {
  ...
  const fetchAllResumes = useCallback(async () => {
    try {
      setLoading(true);
      const respone = await axiosInstance.get(API_PATHS.RESUME.GET_ALL);
      const resumeWithCompletion = respone.data.map((resume) => ({
        ...resume,
  ...
  const handleDeleteResume = async () => {
    ...
    try {
      ...
      toast.error("failed to deleted resume");
    } finally {
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyIconWrapper}>
            ...
            <p className={styles.emptyText}>
              You havn't created any resume yet
            </p>
